...
import { X, Download, Image, FileCode, FileJson, Check, Loader2 } from "lucide-react";
...
export function ExportModal({ isOpen, onClose, elements, stageRef }: ExportModalProps) {
  ...
  const generateSVG = (elements: CanvasElement[], withBackground: boolean): string => {
    // Calculate bounds
    ...
    for (const el of elements) {
      ...
      switch (el.type) {
        ...
        case "ellipse":
          ...
          break;
        case "text":
          svgContent += `<text x="${x}" y="${y + 16}" fill="${stroke}" font-size="16" opacity="${opacity}">${(el as any).text || ""}</text>`;
          break;
      }
    }
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <h2 style={{ fontSize: "18px", fontWeight: 700, color: "white", margin: 0 }}>Export Canvas</h2>
        ...
        <div style={{ padding: "24px" }}>
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ fontSize: "12px", fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "12px", display: "block" }}>
              Export Format
            </label>
              ...
              {EXPORT_OPTIONS.map((option) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor: selectedFormat === option.id ? `${option.color}10` : "white",
                    cursor: "pointer",
                ...
                >
                  ...
                  <span style={{ fontSize: "13px", fontWeight: 600, color: "#374151" }}>{option.label}</span>
          ...
          {(selectedFormat === "png" || selectedFormat === "svg") && (
            <div style={{ marginBottom: "20px" }}>
              ...
              >
                ...
                />
                <span style={{ fontSize: "14px", fontWeight: 500, color: "#374151" }}>Include background</span>
              </label>
            </div>
          )}
