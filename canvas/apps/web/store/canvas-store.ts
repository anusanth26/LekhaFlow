...
const NAMES = ["Unicorn", "Tiger", "Eagle", "Panda", "Fox", "Koala", "Badger", "Lion", "Wolf", "Bear"];
const USER_COLORS = ["#FF5733", "#33FF57", "#3357FF", "#F033FF", "#33FFF5", "#FF33A1", "#A133FF", "#33FFA1"];

const getRandomName = () => NAMES[Math.floor(Math.random() * NAMES.length)] || "User";
const getRandomColor = () => USER_COLORS[Math.floor(Math.random() * USER_COLORS.length)] || "#FF5733";
...
export const useCanvasStore = create<CanvasState & CanvasActions>()(
  subscribeWithSelector((set, get) => ({
    ...
    setConnectionStatus: (isConnected, isSynced) => set((state) => ({
      isConnected,
